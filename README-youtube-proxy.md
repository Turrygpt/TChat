...
## Смена VLESS-конфигурации

Для локального Xray обновите `youtube-bypass/xray-config.json` и перезапустите прокси.
Настройки обхода YouTube не отображаются в панели подключений TChat.
